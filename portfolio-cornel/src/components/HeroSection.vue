...
<template>
  <section class="hero-section">
    <!-- <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h1>Welcome to Digimate</h1>
          <p>Streamline your business processes with our automation tools.</p>
          <a href="#" class="btn btn-primary"><i class="fas fa-play"></i> Learn More</a>
        </div>
        <div class="col-md-6">
          <img src="@/assets/images/play-icon.png" alt="Play" class="img-fluid">
        </div>
      </div>
    </div> -->
